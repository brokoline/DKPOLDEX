...
""".trimIndent(),
            ...
            gradeColor = ModeraterneBrighter,
            offsetX = 80f,
            imageSize = 120.dp,
            logoSize = 160.dp,
            textSize = 40.sp,
...
<p>In 1878, the political work was reorganized with the creation of a formal political party, Socialdemokratisk Forbund. This separated the trade union movement and the political work of the labor movement. However, the two branches of the labor movement worked closely together and were ensured representation in each other's governing bodies through the statutes. In the next 70 years, the party's membership steadily grew to over 300,000 by 1948. Concurrently, the labor movement built an extensive organizational network through the establishment of a wide range of affiliated organizations such as cooperative enterprises, educational associations, and workers' high schools, covering practically all aspects of life.</p>
            ...
            gradeColor = SocialdemokratietBrighter,
            offsetX = 30f,
            imageSize = 130.dp,
            logoSize =80.dp,
            textSize = 40.sp,
...
<p>The first Social Liberal Cabinet was formed in 1909 with Carl Theodor Zahle serving as Prime Minister (1909–1910). From 1913 to 1920, Zahle led the second Social Liberal Cabinet with the Social Democrats serving as parliamentary support, keeping Denmark neutral during World War I. During the Great Depression of the 1930s, the party served as coalition partners along with the Social Democrats, led by Prime Minister Thorvald Stauning, and managed to lead the country through the recession by implementing far-reaching social reforms.</p>
            ...
            gradeColor = RadikalevenstreBrighter,
            offsetX = 40f,
            imageSize = 130.dp,
            logoSize = 120.dp,
            textSize = 40.sp,
...
<body>
 ...
 """.trimIndent()
        ...
        PartyData(
            ...
            gradeColor = KonservativBrighter,
            offsetX = 10f,
            offsetY = 20f,
            imageSize = 75.dp,
            logoSize = 100.dp,
  ...
  <li>EU Policy: Recognizes the importance of a well-functioning European collaboration as a prerequisite for growth and prosperity in Denmark but emphasizes the need for the EU to respect the sovereignty of its member states.</li>
        ...
        PartyData(
            ...
            history = "<html>\n" +
                    ...
                    "</head>\n" +
                    "<body>\n" +
                    "    <p>SF - Socialist People's Party (often simply SF in everyday speech; English: Green Left) is a Danish left-wing political party whose ideological foundation is built around socialism, specifically people's socialism, inspired by democratic socialism and green politics.</p>\n" +
                    "    <p>The party was formed in 1959 by Aksel Larsen, a member excluded from the DKP, who believed that socialism should be introduced through democratic means and without dictates from the Soviet Union. Initially, the focus was largely on the economy and disarmament, but over the years, the party adopted several key issues such as the environment, education, gender equality, and human rights.</p>\n" +
                    "    <p>SF has been a supporting party for various Social Democrat-led governments over time, starting with \"The Red Cabinet\" in 1966-67. In terms of voter support, the party has had three high points where it achieved more than 10% of the votes, followed by periods of decline: the first at the parliamentary election in 1966 under Aksel Larsen, the second during the 1980s with Gert Petersen as leader, and the third at the parliamentary election in 2007 under the relatively newly elected leader Villy Søvndal.</p>\n" +
                    "    <p>Villy Søvndal worked diligently to make SF a governing party and succeeded when SF, together with the Social Democrats and the Danish Social Liberal Party, entered the Helle Thorning-Schmidt Government from 2011 to 2014. However, the government period was not a success for SF, as many members and voters felt that the party had abandoned its traditional policies. Villy Søvndal stepped down as leader in 2012, after which the relatively unknown parliamentary member Annette Vilhelmsen won a contested leadership election against the party leadership's candidate, Health Minister Astrid Krag. SF withdrew from the government in January 2014 following internal disagreements over the state's sale of part of DONG Energy, and Annette Vilhelmsen simultaneously resigned as leader and was succeeded by Pia Olsen Dyhr.</p>\n" +
                    "    <p>In 2019, SF secured 14 seats in the Folketing and 2 members in the European Parliament. SF's youth organization is Socialistisk Folkepartis Ungdom, usually abbreviated as SFU.</p>\n" +
                    "</ul>\n" +
                    "</body>\n" +
                    "</html>",
            website = "https://sf.dk",
        ...
        <h1>Main Principles</h1>
        <ul>
        <li>Socialism and Democracy: Advocates for a socialist society based on solidarity, equality, and sustainability. Aims to strengthen democracy at all levels of society.</li>
        <li>Green Transition: Prioritizes environment and climate with a focus on making Denmark a green pioneer. Promotes sustainable development across all sectors.</li>
                <li>Children and Youth: Works to improve conditions for children and families, including better staff-to-child ratios in daycare institutions. Increases investments in education and children's well-being.</li>
        <li>Climate and Environment: Supports ambitious climate goals and the green energy transition. Invests in plant-based foods and better protection of nature and marine environments.</li>
        <li>Immigration and Integration: Proposes a more humane immigration policy focusing on integration and family reunification. Aims to challenge strict and bureaucratic regulations.</li>
                <li>EU Policy: Engages in a green and solidarity-based European collaboration. Works for joint solutions across borders.</li>
    <li>Welfare and Health: Protects and develops the Danish welfare model with a focus on health and social justice. Aims to improve conditions for employees in the health and care sectors.</li>
    </ul></body>
    </html>
                        """.trimIndent()
        ...
        PartyData(
            ...
            history = "<html>\n" +
                    ...
                    "</head>\n" +
                    "<body>\n" +
                    "    <p>Liberal Alliance (LA) is a Danish liberal-conservative party with 15 seats in the Folketing. The current leader is Alex Vanopslagh.</p>\n" +
                    "    <p>The party originated from the center-right party Ny Alliance, which was formed in 2007, but soon after the parliamentary election, it split due to political disagreements and personal conflicts. Anders Samuelsen, who increasingly emerged as the party's strongman, led the transformation of the party into one with clear economic-liberalist viewpoints. The shift was completed with the name change to Liberal Alliance (LA) in August 2008 and the departure of the original leader Naser Khader from the party in January 2009, after which Anders Samuelsen took over as party leader.</p>\n" +
                    "    <p>The party initially had only two members in the Folketing and seemed doomed with poor polling numbers, but with a program featuring clear key issues, the party gained ground and achieved nine and 13 seats in the parliamentary elections in 2011 and 2015, respectively. From 2016 to 2019, the party entered into the Lars Løkke Rasmussen III Government together with Venstre and the Conservatives. Liberal Alliance held six ministerial positions with Foreign Minister Anders Samuelsen at the helm. In the 2019 parliamentary election, Liberal Alliance lost nine seats, dropping to four seats with 2.3% of the vote. Anders Samuelsen lost his parliamentary seat and stepped down as party leader, with the newly elected Alex Vanopslagh taking over the position. In October 2019, the party was further reduced when the former group leader Simon Emil Ammitzbøll-Bille left the party. However, in the 2022 parliamentary election, the party achieved renewed success and its best result to date with 14 seats, partly due to a communication strategy that placed great emphasis on social media platforms like TikTok.</p>\n" +
                    "    <p>The national chairman is Alex Vanopslagh. Liberal Alliance uses the party letter I, and its youth organization is called Liberal Alliance's Youth.</p>\n" +
                    "</body>\n" +
                    "</html>\n",
            ...
            policies = """
                        ...
                        <body>
                            <h1>Main Principles</h1>
                            <ul>
                                <li>Personal Freedom: Liberal Alliance believes individuals thrive best with maximum freedom to shape their own lives.</li>
                                <li>Open-mindedness: The party supports diversity and accepts different life choices as long as they do not harm others.</li>
                                <li>Less State, More Private: Liberal Alliance advocates for limited state power with lower taxes and less bureaucracy, creating room for private initiative.</li>
                                <li>Freedom with Responsibility: Personal freedom comes with the responsibility for one's own actions and their consequences.</li>
                                <li>Tax Policy: Abolishment of the top tax bracket to increase incentives for work and investment. No taxation on the first 7,000 DKK per month, providing citizens with greater economic freedom. Reduction of corporate taxes to attract investments and create jobs.</li>
                                <li>Welfare: Introduction of welfare accounts, allowing citizens to save for future welfare services under favorable tax conditions. Promotion of free choice between public and private welfare options to improve quality and efficiency.</li>
                                <li>Rule of Law and Democracy: Strengthening legal certainty and ensuring equality before the law for all citizens. Limiting state surveillance and protecting privacy rights.</li>
                                <li>Climate Policy: Achieving 100% CO₂ reduction by 2030 through international cooperation and market-based solutions. Supporting technological innovation and green energy as drivers of sustainable growth.</li>
                            </ul>
                        </body>
                        </html>
        ...
        PartyData(
            ...
            history = "<html>\n" +
                    ...
                    "</head>\n" +
                    "<body>\n" +
                    "    <p>Danish People's Party (DF) is a Danish political party founded in 1995 by Pia Kjærsgaard and three members who split from the Progress Party (Fremskridtspartiet). The party is characterized by its national-conservative, social-conservative, and right-populist ideology.</p>\n" +
                    "    <p>From the beginning, DF distinguished itself by rejecting the Progress Party's ultraliberal and provocative elements, focusing instead on nationalism, strict immigration policies, and opposition to European integration. The party entered the Folketing with four members at its inception.</p>\n" +
                    "    <p>In its first general election in 1998, DF secured 7.4% of the vote and 13 seats. The party continued to grow, achieving 12% and 22 seats in the 2001 elections, making it the third-largest party in the Folketing. DF played a supportive role in various center-right governments, helping to implement stricter immigration laws and other policy initiatives.</p>\n" +
                    "    <p>Pia Kjærsgaard led the party until September 2012, when Kristian Thulesen Dahl took over. Under Thulesen Dahl's leadership, DF reached its peak in the 2015 election, obtaining 21.1% of the vote and 37 seats, becoming the largest party in the blue bloc. Despite this success, the party faced significant challenges in the following years, including scandals related to misuse of EU funds and controversial cooperation with the Social Democrats, which led to a decline in support.</p>\n" +
                    "    <p>In the 2019 European Parliament elections, DF lost three of its four seats, and the same trend continued in the 2019 general election, where it was reduced to 16 seats with 8.7% of the vote. Poor performance in the 2021 municipal elections prompted Kristian Thulesen Dahl to resign in January 2022. Morten Messerschmidt was elected as the new leader but faced further turmoil as 11 of the 16 Folketing members left the party to join the newly formed Denmark Democrats.</p>\n" +
                    "    <p>In the 2022 general election, DF experienced its worst result to date, securing only 2.6% of the vote and five seats. The party remains known for its skepticism towards immigration and its defense of certain welfare state elements, positioning itself on the right side of the political spectrum.</p>\n" +
                    "    <p>As of early 2023, DF is the ninth-largest party in the Folketing. The party's youth organization is Dansk Folkepartis Ungdom, and it is part of the Identity and Democracy group in the European Parliament. Morten Messerschmidt continues to lead the party, navigating ongoing challenges related to leadership and membership stability.</p>\n" +
                    "</body>\n" +
                    "</html>\n",
            ...
            gradeColor = DanskfolkepartiBrighter,
            offsetX = 80f,
            offsetY = 15f,
            imageSize = 100.dp,
            logoSize = 120.dp,
            ...
            policies = """
                          ...
                          <body>
                              <h1>Main Principles</h1>
                              <ul>
                                  <li>National Sovereignty: Dansk Folkeparti seeks to preserve Denmark's independence and opposes further transfer of sovereignty to the EU.</li>
                                  <li>Cultural Preservation: The party works to protect Danish culture and traditions from influences they consider to be in conflict with Danish values.</li>
                                  <li>Immigration Policy: Dansk Folkeparti pursues a strict immigration policy and aims to limit immigration, particularly from non-Western countries. The party works to deport criminal and unintegrated foreigners back to their countries of origin.</li>
                                  <li>Social Policy: The party advocates for a responsible and dignified social policy where care and support for vulnerable citizens are public responsibilities. They believe a society should be judged by how it treats its weakest members.</li>
                                  <li>Environmental Policy: The overarching goal is to prevent human intervention that disrupts nature's balance to ensure a healthy environment for present and future generations.</li>
                                  <li>EU Policy: Dansk Folkeparti is skeptical of the EU and advocates for an open and democratic collaboration among independent nations without a European elite rule.</li>
                              </ul>
                          </body>
                          </html>
        ...
        PartyData(
            ...
            history = "<html>\n" +
                    ...
                    "</head>\n" +
                    "<body>\n" +
                    "    <p>Denmark Democrats (Danmarksdemokraterne) is a right-leaning political party in Denmark, founded in 2022 by Inger Støjberg, who also serves as the party leader. The party advocates for strict immigration policies and positions itself as a civil-oriented party within the traditional blue bloc.</p>\n" +
                    "    <p>In its first parliamentary election in 2022, Denmark Democrats secured 14 seats, making it the second-largest party in the blue bloc. By March 2024, the party increased its representation to 16 seats, becoming the third-largest party in the Folketing. Additionally, in the 2024 European Parliament elections, the party won one seat.</p>\n" +
                    "    <p>Inger Støjberg, the party's founder, was sentenced to 60 days of unconditional imprisonment on December 13, 2021, for violating the ministerial responsibility law. Previously, she served as the deputy leader and a member of Venstre but resigned from her deputy position in December 2020 and left the party entirely in February 2021. Following her conviction, Støjberg was deemed unfit to remain in the Folketing by a majority vote in December 2021. She served her sentence under house arrest in Hadsund from March 28, 2022, and was released on May 26, 2022. Upon her release, she held a thank-you event at Visborggaard Castle near Hadsund with approximately 2,000 attendees, where she expressed her continued passion for politics and hinted at announcing her political future, leading to speculation about the formation of a new party.</p>\n" +
                    "    <p>Inger Støjberg remains the national chairman of Denmark Democrats. The party emphasizes a strict stance on immigration and seeks to influence Denmark's political landscape from the right side of the spectrum. Denmark Democrats continue to build their presence both nationally and in the European Parliament, navigating the challenges of establishing a new political force in Denmark's dynamic political environment.</p>\n" +
                    "</body>\n" +
                    "</html>\n",
            ...
            gradeColor = DanmarksdemokraterneBrighter,
            offsetX = 30f,
            offsetY = 10f,
            imageSize = 100.dp,
            logoSize = 120.dp,
            ...
            policies = """
                       ...
                       <body>
                           <h1>Main Principles</h1>
                           <ul>
                               <li>Denmark in Balance: The party works to create equal opportunities and development across the entire country, with a focus on strengthening areas outside the major cities.</li>
                               <li>Immigration Policy: Danmarksdemokraterne pursues a strict immigration policy focusing on integration and requirements for understanding Danish culture and language.</li>
                               <li>Health: The party aims for a healthcare system closer to citizens, ensuring better access to doctors and healthcare services throughout the country.</li>
                               <li>Production Denmark: Danmarksdemokraterne works to strengthen Danish businesses and ensure favorable conditions for production and industry.</li>
                               <li>EU Policy: The party seeks to limit EU influence on Danish matters and advocates for a more independent Denmark within the EU.</li>
                           </ul>
                       </body>
                       </html>
        ...
        PartyData(
            ...
            history = "<html>\n" +
                    ...
                    "</head>\n" +
                    "<body>\n" +
                    "    <p>The Red-Green Alliance (Enhedslisten) is a Danish left-wing political party established in 1989 through the merger of the Left Socialists (Venstresocialisterne), Communist Party of Denmark (DKP), and the Socialist Workers Party (SAP). The party identifies with democratic socialism, eco-socialism, and feminism, advocating for extensive social welfare programs, environmental sustainability, and gender equality.</p>\n" +
                    "    <p>Enhedslisten was formed as a unification of various leftist factions aiming to create a stronger, more cohesive political force in Denmark's parliament, the Folketing. The merger sought to consolidate efforts to address issues such as workers' rights, social justice, and opposition to neoliberal economic policies.</p>\n" +
                    "    <p>In its early years, Enhedslisten focused on grassroots activism and building a broad base of support among workers, students, and marginalized communities. The party has consistently pushed for progressive policies, including the expansion of public services, increased taxation on the wealthy, and robust environmental protections to combat climate change.</p>\n" +
                    "    <p>Enhedslisten has gradually increased its representation in the Folketing, becoming a significant voice for the left. The party emphasizes direct democracy, participatory decision-making, and solidarity with international socialist movements. It has also been active in promoting anti-racist initiatives and advocating for the rights of immigrants and refugees.</p>\n" +
                    "    <p>As of early 2025, Enhedslisten holds a notable number of seats in the Folketing, positioning itself as a key player in shaping Denmark's progressive agenda. The party continues to advocate for comprehensive climate policies, enhanced social welfare systems, and the dismantling of capitalist structures that it views as inherently exploitative. Enhedslisten remains committed to fostering an inclusive and equitable society through its unwavering dedication to socialist principles and environmental sustainability.</p>\n" +
                    "    <p>Enhedslisten operates with a strong emphasis on internal democracy, allowing members to have significant input into the party's policies and leadership decisions. The party's youth wing, Rød Ungdom (Red Youth), actively engages younger generations in political activism and advocacy, ensuring the continuity of the party's values and objectives.</p>\n" +
                    "</body>\n" +
                    "</html>\n",
            ...
            gradeColor = EnhedslistenBrighter,
            offsetX = 90f,
            offsetY = 15f,
            imageSize = 90.dp,
            logoSize = 120.dp,
            ...
            policies = """
                        ...
                        <body>
                            <h1>Main Principles</h1>
                            <ul>
                                <li>Socialism and Democracy: Enhedslisten works to create a socialist democracy in Denmark by expanding democracy and combating the negative effects of capitalism, such as inequality and environmental destruction.</li>
                                <li>Green Transition: The party prioritizes environmental protection and sustainable development, aiming to make Denmark a green pioneer country.</li>
                                <li>Social Policy: Enhedslisten fights against social inequality and poverty and advocates for strengthening and expanding the welfare state. The party believes in inclusion for all, regardless of gender, sexuality, disability, or ethnic background.</li>
                                <li>Economic Policy: The party is strongly anti-capitalist and has notably opposed tax evasion through transfer pricing, where multinational companies minimize their tax payments by placing profits in low-tax countries. Enhedslisten advocates for a larger public sector to improve the quality of life for public employees and citizens.</li>
                                <li>Education: The party believes everyone should have free access to education and opposes tuition fees, as they hinder equal opportunities for obtaining an education.</li>
                                <li>Foreign Policy: Enhedslisten supports a foreign policy based on respect for human rights and aims to double development aid. The party advocates for Denmark to leave NATO.</li>
                                <li>EU Policy: Enhedslisten is critical of the EU and believes Denmark should be allowed to implement better rules if a majority in Denmark supports them, even if it challenges the EU’s internal market.</li>
                            </ul>
                        </body>
                        </html>
                        """.trimIndent()
        ...
        PartyData(
            ...
            history = "<html>\n" +
                    "<head>\n" +
                    "    <style>\n" +
                    "        body { font-family: Arial, sans-serif; line-height: 1.6; padding: 16px; margin: 0; color: #333; font-weight: bold; background-color: white; color: black;  }\n" +
                    "        h1 { color: #78C850; }\n" +
                    "        p { margin-bottom: 16px; }\n" +
                    "    </style>\n" +
                    "</head>\n" +
                    "<body>\n" +
                    "    <p>The Alternative (Alternativet) is a Danish green and progressive political party founded in 2013 by Josephine Fock and other activists. The party focuses on sustainability, social innovation, and fostering a green economy, positioning itself as a forward-thinking alternative to traditional political parties. Alternativet advocates for comprehensive climate policies, social justice, and participatory democracy, aiming to address contemporary societal challenges through innovative solutions.</p>\n" +
                    ...
                    "    <p>As of early 2025, The Alternative continues to promote its agenda within the Folketing, emphasizing environmental sustainability, economic reform, and social equity. The party actively engages its youth wing, Alternative Youth, to involve younger generations in political activism and to sustain its progressive initiatives.</p>\n" +
                    "</body>\n" +
                    "</html>\n",
            ...
            gradeColor = AlternativetBrighter,
            offsetX = 80f,
            imageSize = 100.dp,
            logoSize = 120.dp,
            textSize = 40.sp,
            ...
            policies = """
                        ...
                        <head>
                            <style>
                                body { font-family: Arial, sans-serif; line-height: 1.6; padding: 16px; margin: 0; color: black; font-weight: bold; background-color: white; color: black; }
                                h1 { color: #black; }
                                ul { margin: 16px 0; padding-left: 20px; }
                                li { margin-bottom: 8px; }
                            </style>
                        ...
                        <body>
                            <h1>Main Principles</h1>
                            <ul>
                                <li>Alternativet is built on six core values: Courage, Generosity, Transparency, Humility, Humor, and Empathy. These values form the foundation of the party’s policies and approach to societal development.</li>
                                <li>Climate and Sustainability: Advocates for a serious sustainable transition in Denmark with a focus on the environment and climate.</li>
                                <li>New Political Culture: Aims to renew the political culture through transparency, inclusion, and dialogue.</li>
                                <li>Social Justice: Strives for a society with less inequality and more social justice.</li>
                                <li>Economic Sustainability: Promotes an economy that supports green transition and social balance.</li>
                            </ul>
                        </body>
                        </html>
        ...
        PartyData(
            ...
            gradeColor = SambandspartietBrighter,
            offsetX = 70f,
            offsetY = 15f,
            imageSize = 100.dp,
            logoSize = 120.dp,
            ...
            policies = """
                       ...
                       <body>
                           <h1>Main Principles</h1>
                           <ul>
                               <li>Preservation of the Realm Community: The party's primary goal is to preserve and strengthen the Faroe Islands' connection to Denmark.</li>
                               <li>Social Liberal Policy: Sambandsflokkurin pursues a social liberal policy focusing on individual freedom, business development, and social considerations.</li>
                               <li>Economic Policy: The party promotes a conservative-liberal economic policy emphasizing business development and economic growth.</li>
                               <li>Cultural Issues: Sambandsflokkurin is engaged in cultural matters and works to strengthen Faroese culture and identity within the framework of the Realm Community.</li>
                               <li>Reform of the Realm Community: The party proposes reforms to the Realm Community, ensuring that areas such as the constitution, currency, monarchy, judicial system, police, prosecution service, corrections system, and foreign, security, and defense policies (partially) remain shared matters between the Faroe Islands and Denmark.</li>
                           </ul>
                       </body>
                       </html>
        ...
        PartyData(
            ...
            history = "<html>\n" +
                    ...
                    "</head>\n" +
                    "<body>\n" +
                    "    <p>Siumut (meaning \"Forward\") is a major social-democratic political party in Greenland, founded in 1977. The party advocates for Greenlandic self-government, social welfare policies, and economic development, while maintaining strong ties with Denmark. Siumut has been a dominant force in Greenlandic politics since the establishment of home rule, frequently leading the government and providing several Prime Ministers, including Jonathan Motzfeldt, Lars Emil Johansen, Hans Enoksen, Kuupik Kleist, and Aleqa Hammond.</p>\n" +
                    "    <p>The party focuses on issues such as education, healthcare, sustainable fisheries, and infrastructure development, aiming to improve the quality of life for Greenland's residents. Siumut traditionally garners support from urban areas and has maintained a significant presence in the Inatsisartut, Greenland's parliament. As of early 2025, Siumut continues to play a key role in shaping Greenland's political landscape, advocating for policies that balance economic growth with social equity and environmental sustainability.</p>\n" +
                    "</body>\n" +
                    "</html>\n",
            ...
            policies = """
                        ...
                        <body>
                            <h1>Main Principles</h1>
                            <ul>
                                <li>Social Democracy: Siumut pursues a social democratic policy focusing on social justice and welfare.</li>
                                <li>Independence: The party works to strengthen Greenland's self-governance within the Realm Community with Denmark, with a long-term vision of full independence achieved in cooperation with Denmark.</li>
                                <li>Economic Development: Siumut promotes a sustainable economic policy that supports growth and development in Greenland.</li>
                                <li>Education: The party prioritizes education as a key factor for societal development and works to improve the education system.</li>
                                <li>Environment and Natural Resources: Siumut advocates for the responsible use of Greenland's natural resources, with respect for the environment and future generations.</li>
                                <li>Health and Welfare: The party works to ensure all citizens have access to healthcare services and a strong social safety net.</li>
                            </ul>
                        </body>
                        </html>
        ...
        PartyData(
            ...
            policies = """
                       ...
                       <body>
                           <h1>Main Principles</h1>
                           <ul>
                               <li>Socialism and Independence: The party strives for an economically and politically independent Greenland, guided by the principles of sustainability.</li>
                               <li>Sustainable Development: Inuit Ataqatigiit emphasizes that Greenland's resources should benefit the entire society and that political efforts should be based on equality, mutual respect, and solidarity.</li>
                               <li>Social Justice: The party works to develop a strong, just, and sustainable society with room for everyone, based on democracy, equality, and human rights.</li>
                               <li>Education and Culture: Inuit Ataqatigiit prioritizes education and cultural strength as foundations for Greenland's future.</li>
                           </ul>
                       </body>
                       </html>
        ...
        PartyData(
            ...
            history = "<html>\n" +
                    ...
                    "</head>\n" +
                    "<body>\n" +
                    "    <p>An independent, known in Danish as a \"løsgænger,\" is an elected representative who does not belong to any political party or group. Typically, individuals become independents by resigning from or being expelled from their party during their term. Since the 1953 Constitution, only Jacob Haugaard was elected to the Folketing as an independent following the 1994 election, aside from Hans Schmidt in 1953, who was technically elected as an independent while representing the Schleswig Party.</p>\n" +
                    "    <p>Independents are more common in local politics than in the Folketing because party structures play a significant role in providing support and expertise to members, making it challenging for individuals to cover all political areas on their own.</p>\n" +  "<p>Officially, elected representatives are not referred to as independents but as being outside of parties, abbreviated in the Folketing as UFG (udenfor folketingsgrupperne). The term \"løsgænger\" is somewhat humorous, originally referring to someone without a fixed residence or occupation.</p>\n" + "<p>Historically, being an independent was punishable by law.</p>\n" +
                    "    <p>In the European Parliament, there are several independents who may be members of national parties but do not join other parliamentarians in a group.</p>\n" +
                    "</body>\n" +
                    "</html>\n",
            ...
            policies = """
                        ...
                        <body>
                            <h1>Policies positions</h1>
                            <ul>
                                <li>Individual priorities: Independent politicians typically base their policies on personal beliefs, key issues, or causes that may range from environmental policy to economic reform. They often have a freer role and can address specific issues without being bound by a party platform.</li>
                                <li>Independence: Independents operate outside of party politics, allowing them to take positions on a case-by-case basis without regard for party lines or internal majority decisions.</li>
                                <li>Political positions: There is no fixed political direction for independents, as they may range from the far-right or far-left to pragmatic and centrist positions. They often focus on issues that led to their break from a former party or specific ideological divides.</li>
                                <li>Pragmatism or protest: Some independents aim to create concrete solutions in collaboration with other parties. Others may be protest politicians primarily opposing systems, institutions, or policies they were previously part of.</li>
                                <li>Limited influence: Without a party backing them, independents may have limited parliamentary power but can gain significant attention if they represent controversial or popular viewpoints.</li>
                                <li>Notable examples in Denmark include politicians like Uffe Elbæk and Simon Emil Ammitzbøll-Bille, who left their parties due to ideological disagreements or personal conflicts and later founded their own parties.</li>
                                <li>Voting in parliament: Independents have the freedom to vote independently of party blocs, allowing them to support one side on one issue and the other side on another.</li>
                                <li>Visibility: Independents may find it harder to gain media coverage and influence unless their issues or personalities attract significant attention.</li>
                                <li>Practical Collaboration: They often need to collaborate with parties or other politicians to gain support for their proposals.</li>
                            </ul>
                        </body>
                        </html>
